...
public class IntStreamOperations {
    public static void main(String[] args) {
        ...
        System.out.printf("Sum of squares via map and sum: 5d%n%n", IntStream.of(values).map(x -> x * x).sum());
        System.out.printf("Values displayed in sorted order: %s%n", IntStream.of(values).sorted()
